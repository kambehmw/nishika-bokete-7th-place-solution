...
class ModalEmbeddings(nn.Module):
    ...
    def __init__(self, config, encoder, embeddings):
        ...
        self.proj_embeddings = nn.Linear(config.modal_hidden_size, config.d_model)
        # print(embeddings)
    ...
    def forward(self, input_modal, start_token=None, end_token=None, position_ids=None, token_type_ids=None):
        ...
        if start_token is not None:
            ...
            seq_length += 1
            # print(start_token_embeds.size())
            # print(token_embeddings.size())
            token_embeddings = torch.cat([start_token_embeds.unsqueeze(1), token_embeddings], dim=1)
            # token_embeddings = torch.cat([start_token_embeds, token_embeddings], dim=1)
...
class MMBTModel(nn.Module, ModuleUtilsMixin):
    def __init__(self, config, transformer, encoder):
        ...
        self.modal_encoder = ModalEmbeddings(config, encoder, transformer.shared)
    ...
    def forward(
        ...
        txt_embeddings = self.transformer.shared(input_ids)
