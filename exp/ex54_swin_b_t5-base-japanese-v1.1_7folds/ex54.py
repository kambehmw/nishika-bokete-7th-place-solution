...
from transformers import (
    AutoTokenizer, AutoModel, MMBTConfig, AutoConfig,
    Trainer, TrainingArguments, T5Tokenizer, T5EncoderModel
)
import transformers
...
class CFG:
    ...
    text_model="sonoisa/t5-base-japanese-v1.1"
    max_len=128
    seed=42
    n_fold=7
    num_labels=2
...
def train_loop(folds, fold):
    ...
    transformer = T5EncoderModel.from_pretrained(CFG.text_model)
