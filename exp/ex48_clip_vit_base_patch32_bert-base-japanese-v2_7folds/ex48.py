...
class CFG:
    vision_model_weight="openai/clip-vit-base-patch32"
...
processor = CLIPProcessor.from_pretrained(CFG.vision_model_weight)
...
def train_loop(folds, fold):
    ...
    trn_ds = BoketeTextImageDataset(train_folds, tokenizer, CFG.max_len, processor)
    val_ds = BoketeTextImageDataset(valid_folds, tokenizer, CFG.max_len, processor)
...
test_ds = BoketeTextImageDataset(test_df, tokenizer, CFG.max_len, processor)
