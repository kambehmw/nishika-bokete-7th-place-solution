...
from torchvision.models import ResNet152_Weights, resnet152, ViT_B_16_Weights, vit_b_16
...
class CFG:
    vision_model_weight=ViT_B_16_Weights.IMAGENET1K_V1
...
class ImageEncoder(nn.Module):
    def __init__(self, pretrained_weight):
        super().__init__()
        self.model = vit_b_16(weights=pretrained_weight)
        self.fc = nn.Linear(self.model.hidden_dim, 2048)
